...
The script attempts to:
  • extract a human-readable title from each MP4 filename
  • find the best matching episode using fuzzy title matching
  • copy the file to destination_folder using this pattern:
